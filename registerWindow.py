...
class RegisterWindow(customtkinter.CTk):
    ...
    def __init__(self) -> None:
        ...
        self.entry = customtkinter.CTkEntry(master=self.frame_right,
                                            ...
                                            corner_radius=10)
        self.entry.grid(row=0, column=0, columnspan=2, pady=20, padx=20, sticky="we")
        ...
        self.entry3.grid(row=3, column=0, columnspan=2, pady=20, padx=20, sticky="we")
        ...
        self.label_info = customtkinter.CTkLabel(master=self.frame_info, 
                                                text="Please, fill int the blanks on the side to start betting.",
                                                height=100, fg_color=("white", "gray38"), 
        ...
        self.label_mode.grid(row=9, column=0, pady=10, padx=10, sticky="w")
        self.option_var = tkinter.StringVar(value="Dark")
        self.option_menu_1 = customtkinter.CTkSwitch(master=self.frame_left, text="Dark Mode", variable=self.option_var, onvalue="Dark", offvalue="Light")
        self.option_menu_1.configure(command=self.change_appearance_mode)
        self.option_menu_1.grid(row=10, column=0, pady=10, padx=20, sticky="w")
    ...
    def save_data(self) -> None:
        ...
        with open('data.csv', mode='w') as data_file:
            ...
            data_writer.writerow([self.entry.get().lower(), self.entry2.get(), self.entry3.get()])
